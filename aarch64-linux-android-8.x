...
cd ../gcc/gcc-UBER && rm -rf * && git reset --hard && git fetch kk uber-8.0 && git checkout FETCH_HEAD;
cd ../../binutils/binutils-uber && rm -rf * && git reset --hard && git fetch kk 2.30 && git checkout FETCH_HEAD;
cd ../../
